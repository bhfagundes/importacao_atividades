...
use Flash;
use Response;
use App\Imports\ConteudoTributarioImport;
...
class ConteudoController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('conteudo_tributario.index');
    }
    ...
    {
        return view('conteudo_tributario.create');
    }
    ...
    public function store(CreateAtividadesRequest $request)
    {
        ...
        $data=Excel::import(new ConteudoTributarioImport, $request->file('excel'));
